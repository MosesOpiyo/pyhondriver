...
def region_of_interest(img, vertices):
    ...
    match_mask_color = (0,255,0) # <-- This line altered for grayscale.
...
while (True):
    ...
    minimapSize =  50
    cv2.rectangle(frame, (minimapCenterX - minimapSize, minimapCenterY - minimapSize), (minimapCenterX + minimapSize, minimapCenterY), ( 0,255, 0), 1)
        ...
        for i in range(rows):
            for j in range(cols):
                ...
                if val:
                    ...
                    cnt += 1
        if cnt < 1:
            cv2.circle(minimap, (curCenterX, curCenterY), 10, (255, 0, 0))
            continue

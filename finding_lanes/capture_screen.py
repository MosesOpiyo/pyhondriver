...
def draw_lanes(img, lines, color=[0, 255, 0], thickness=2):
...
def process_img(original_image):
    ...
    vertices = np.array([[220,650],[220,500],[600,400],[650,400],[1200,480],[1200,650]],np.int32)
...
last_time = time.time()
while(True):
    screen = np.array(ImageGrab.grab(bbox=(0,40,1000,550)))
